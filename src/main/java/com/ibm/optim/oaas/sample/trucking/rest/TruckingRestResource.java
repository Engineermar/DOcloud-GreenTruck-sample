...
public class TruckingRestResource {
	...
	public TruckingRestResource(TruckingManager manager) {
	...
	public Shipment addShitment(Shipment s) {
	...
	public Response getShipment(@PathParam("id") String id) {
		Shipment s = manager.getShipment(id);
		if (s != null) {
	...
	public Response updateShipment(@PathParam("id") String id, Shipment s) {
